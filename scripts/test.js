(function () {
    const Test = {
        ...
        startQuiz() {
            ...
            this.questionTitleElement = document.getElementById('tittle');
        ...
        showQuestion() {
            ...
            if (chosenOption && chosenOption.chosenAnswerId) {
                ...
                this.passElement.removeAttribute('disabled');
            } else {
                this.nextButtonElement.setAttribute('disabled', 'disabled');
                this.passElement.setAttribute('disabled', 'disabled');
            }
        ...
        complete() {
            ...
            if (xhr.status === 200 && xhr.responseText) {
                ...
                if (result) {
                    let answers = [];
                    Array.from(this.userResult).forEach(function (elem) {
                        answers.push(elem.chosenAnswerId);
                    });
                    location.href = 'result.html' + location.search + '&score=' + result.score + '&total=' + result.total + '&answers=' + answers;
                }
            } else {
                location.href = 'index.html';
            }
